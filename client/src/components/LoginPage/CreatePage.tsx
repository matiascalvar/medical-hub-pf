...
import {FaAt, FaLock, FaUserAlt, FaUserCircle, FaRegIdCard, FaPhoneSquareAlt, FaGoogle} from 'react-icons/fa';
    ...
    <div className='containerCreate'>
      <div className="containerCreate__register">
        ...
        <div className="createRegister__redes">
          ...
          <p className="redes__title">Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
        </div>
        <div className="container__register">
          ...
          <div className="register__item register__select">
            ...
            <select name="plan" className="register__plan">
              <option value="particular" className="plan__option">Particular</option>
              <option value="planA" className="plan__option">Plan A</option>
              <option value="planB" className="plan__option">Plan B</option>
            </select>
          </div>
